...
export async function getAllContent(
  ...
  return {
    introData: introData?.data?.allContentCollection?.items?.[0]?.introSection,
    infoData: infoData?.data?.allContentCollection?.items?.[0]?.infoSection,
    ethosData: {
      ...ethosData?.data?.allContentCollection?.items?.[0]?.ethosSection,
      season:
        introData?.data?.allContentCollection?.items?.[0]?.introSection?.season,
    },
    contactData:
      contactData?.data?.allContentCollection?.items?.[0]?.outroSection,
  };
}
